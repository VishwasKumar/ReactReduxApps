...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    { store: store },
	    _react2.default.createElement(_container.CommentsList, null)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CommentList = __webpack_require__(198);
	
	var _action = __webpack_require__(200);
	
	var CommentsList = exports.CommentsList = (0, _reactRedux.connect)(function mapStateToProps(state) {
	    return { comments: state };
	}, function mapDispatchToProps(dispatch) {
	    return {
	        addComment: function addComment(author, text) {
	            return dispatch((0, _action.addComment)(author, text));
	        }
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var warning = __webpack_require__(166);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function CommentList(props) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement("input", { type: "text", id: "author", placeholder: "Name" }),
	        _react2.default.createElement("input", { type: "text", id: "text", placeholder: "Comment.." }),
	        _react2.default.createElement(
	            "button",
	            { onSubmit: (0, _action.addComment)("vishwas", "test") },
	            "Post"
	        )
	    );
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        case 'ADD_COMMENT':
	            return state.push((0, _immutable.Map)(action.payload));
	        default:
	            return state;
	    }
	}
